...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Acelerar") action Preference("auto-forward", "toggle")
            textbutton _("Salvar") action ShowMenu('save')
            textbutton _("Salvar Já") action QuickSave()
            textbutton _("Carregar Já") action QuickLoad()
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Feito usando o {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("Espaço Vazio")):
            ...
            hbox:
                ...
                if config.has_autosave:
                    textbutton _("{#auto_}A") action FilePage("auto")
        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Tipo de Exibição")
                        textbutton _("Modo Janela") action Preference("display", "window")
                        textbutton _("Tela Cheia") action Preference("display", "fullscreen")

                vbox:
                    style_prefix "radio"
                    label _("Retroceder Falas")
                    textbutton _("Desabilitado") action Preference("rollback side", "disable")
                    textbutton _("Tocar na Esquerda") action Preference("rollback side", "left") text_size 20
                    textbutton _("Tocar na Direita") action Preference("rollback side", "right") text_size 20

                vbox:
                    style_prefix "check"
                    label _("Pular")
                    textbutton _("Textos não Visualizados") action Preference("skip", "toggle") text_size 18
                    textbutton _("Depois das Escolhas") action Preference("after choices", "toggle") text_size 18
                    textbutton _("Transições") action InvertSelected(Preference("transitions", "toggle")) text_size 18
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Velocidade do Modo Automático") text_size 20
...
screen history():
    ...
    use game_menu(_("Histórico"), scroll=("vpgrid" if gui.history_height else "viewport")):
        ...
        if not _history_list:
            label _("O Histórico de diálogos está vazio.")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança Dialogos/Acessa Botões na Interface.")

    hbox:
        label _("Espaço")
        text _("Avança Diálogos Rápidamente.")
    ...
    hbox:
        label _("Esc")
        text _("Acessa os Menus.")

    hbox:
        label _("Ctrl")
        text _("Ao Manter Precionado, Pulará os Diálogos.")

    hbox:
        label _("Tab")
        text _("Ao Precionar, Pulará Diálogos até a tecla ser precionada novamente.")

    hbox:
        label _("Page Up")
        text _("Volta Diálágos.")

    hbox:
        label _("Page Down")
        text _("Avança Diálogos.")

    hbox:
        label "H"
        text _("Oculta a Interface.")
    ...
    hbox:
        label "V"
        text _("Ativa o Modo de {a=https://www.renpy.org/l/voicing}Acessibilidade (Voz){/a}.")
...
screen mouse_help():
    ...
    hbox:
        ...
        text _("Avança Dialogos/Clica em botões.")

    hbox:
        label _("Botão Central (Roda)")
        text _("Oculta a Interface.")
    ...
    hbox:
        label _("Rolar Roda para Cima")
        text _("Volta Diálogos.")

    hbox:
        label _("Rolar Roda para Baixo")
        text _("Avança Diálogos.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Botão Superior Direito")
        text _("Avança Diálogos.")

    hbox:
        label _("Direcionais, Analogicos")
        text _("Navega pela Interface.")

    hbox:
        label _("Start, Botão Guia")
